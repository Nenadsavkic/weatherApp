      ...
      @foreach ($response as $element)
        ...
        <div class="col-md-4 mt-5">
            <div class="card" style="background: #ff9800; width: 23rem; margin: 5px auto;">
                <img src="<?php echo " http://openweathermap.org/img/wn/". $element['weather']['0']['icon'].".png"; ?>"
                style="width: 90px; margin: 5px auto" class="card-img-top">
                <div class="card-body text-center text-light">
                  <h5 class="card-title"><strong>{{ $element['name'] }}</strong></h5>
                  <p class="card-text">Temperature: <strong>{{ round($element['main']['temp']) }} &deg C </strong></p>
                  <p class="card-text">Weather:  <strong>{{ $element['weather']['0']['description'] }}</strong></p>                                     
                </div>
              </div>
        </div>
